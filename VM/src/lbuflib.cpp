...
template int buffer_readinteger<int8_t>(lua_State* L);
template int buffer_readinteger<uint8_t>(lua_State* L);
template int buffer_readinteger<int16_t>(lua_State* L);
template int buffer_readinteger<uint16_t>(lua_State* L);
template int buffer_readinteger<int32_t>(lua_State* L);
template int buffer_readinteger<uint32_t>(lua_State* L);
template int buffer_readinteger<uint16_t>(lua_State* L);
template int buffer_readinteger<int64_t>(lua_State* L);
template int buffer_readinteger<uint64_t>(lua_State* L);

template int buffer_readfp<float, uint32_t>(lua_State* L);
template int buffer_readfp<double, uint64_t>(lua_State* L);
template int buffer_writeinteger<int8_t>(lua_State* L);
template int buffer_writeinteger<uint8_t>(lua_State* L);
template int buffer_writeinteger<int16_t>(lua_State* L);
template int buffer_writeinteger<uint16_t>(lua_State* L);
template int buffer_writeinteger<int32_t>(lua_State* L);
template int buffer_writeinteger<uint32_t>(lua_State* L);
template int buffer_writeinteger<int64_t>(lua_State* L);
template int buffer_writeinteger<uint64_t>(lua_State* L);
template int buffer_writefp<float, uint32_t>(lua_State* L);
template int buffer_writefp<double, uint64_t>(lua_State* L);